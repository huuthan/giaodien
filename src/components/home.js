    ...
    constructor(props){
        ...
        this.state={
            data:[
                ...
                {key:'3',name:'Khẩu phần ăn',uriImage:require('../images/icons8-meal-80.png'),color:'#39AFD5'},
                {key:'4',name:'Album ảnh',uriImage:require('../images/icons8-photo-gallery-80.png'),color:'#2ecc71'},
                {key:'5',name:'Hoạt động',uriImage:require('../images/icons8-running-50.png'),color:'#C49FC7'},
